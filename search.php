...
<div class="container">
  ...
  if (isset($_POST['startsearch'])) {
    ...
    $query = "SELECT * FROM posts WHERE post_name LIKE '%$search_data%' ORDER BY id DESC";
  ...
  ?>
    ...
    <nav class="mt-3 mb-5" aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item " aria-current="page"><?php echo $search_data; ?></li>
      </ol>
    </nav>
    <!--Breadcrumb Fnished-->
    <?php
    ...
    ?>
      <div class="alert alert-warning" role="alert">
        <?php echo $search_data; ?> ile İlgili Bir Sonuç Bulunamadı.
      </div>
      <?php
    } else {
